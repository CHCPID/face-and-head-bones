...
lib.ssMetadata = [
		{name:"Bones_atlas_1", frames: [[0,0,2360,1640],[0,1642,2360,1640],[991,6568,478,351],[0,6568,989,760],[0,3284,2360,1640],[0,4926,2360,1640],[1471,6568,277,272],[2362,0,2360,1640],[2362,1642,2360,1640],[2362,3284,2360,1640],[1750,6568,221,196],[2362,4926,2360,1640]]}
];
...
(lib.SpheniodDOWN = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
if (reversed == null) { reversed = false; }
	...
	this.instance_2 = new lib.SpheniodDOWN();
	this.instance_2.setTransform(743.9,521.5,1,1,0,0,0,743.9,518.5);
	new cjs.ButtonHelper(this.instance_2, 0, 1, 1);

	this.instance_3 = new lib.Bones1Sphenoidcolor();
	this.instance_3.setTransform(0,0,0.6304,0.6304);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_1,p:{y:0}},{t:this.instance,p:{x:0,y:-3}}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_3},{t:this.instance_1,p:{y:-3}},{t:this.instance,p:{x:2,y:-6}}]},1).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		*/
		_this.EthmoidButton.on('dblclick', function(){
		/*
		Makes the specified object visible or invisible.
		*/
		_this.EthmoidButton.visible = true;
		});
		var _this = this;
		/*
		...
		*/
		...
		_this.SpheniodButton.on('mouseover', function(){
		/*
		Makes the specified object visible or invisible.
		*/
		_this.SpheniodButton.visible = true;
		});
